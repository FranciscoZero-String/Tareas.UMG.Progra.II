...
import javafx.scene.control.Alert;
 ...
 class AccesoDatosJDBC {
    ...
    private static final String SQL_INSERT = "INSERT INTO empleados(nombre, enero, febrero, marzo, total, promedio) VALUES(?,?,?,?,?,?)";
    private static final String SQL_UPDATE = "UPDATE empleados SET nombre = ?, enero = ?, febrero = ?, marzo = ?, total = ?, promedio = ? WHERE codigo = ?";
    private static final String SQL_DELETE = "DELETE FROM empleados WHERE codigo = ?";
